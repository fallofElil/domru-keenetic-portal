...
function updateInput() {
    const inputs = document.querySelectorAll("#otp_confirm_call .otp-input__field");
    const hiddenInputOtpValue = document.querySelector("#otp_confirm_call input[name=otp_value]")
    const submitBtn = document.querySelector('#btn_submit_confirm_phone_call')
...
function changeDescriptionText() {
    ...
    headerDescription.textContent = `На номер ${ getAndMaskUserPhoneNumber() } поступит звонок`
}
